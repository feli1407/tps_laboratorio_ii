...
{
    public partial class FrmAgregarJuegoNintendo : Form
    {
        public JuegoNintendo juegoNintendo;
        public FrmAgregarJuegoNintendo()
        {
            InitializeComponent();
        ...
        /// <summary>
        /// Crea y asigna un nuevo juego de nintendo con los datos de los textbox y combobox.
        /// </summary>
        ...
        private void btnAgregar_Click(object sender, EventArgs e)
        {
            ...
            {
                juegoNintendo = new JuegoNintendo(this.txtNombre.Text, Convert.ToInt32(this.txtPrecioCompra.Text), (EGenero)this.cboGenero.SelectedItem, this.chbExclusivoNintendo.Checked ,Convert.ToInt32(this.txtCantidad.Text));
        ...
        private void FrmAgregarJuegoNintendo_Load(object sender, EventArgs e)
        {
